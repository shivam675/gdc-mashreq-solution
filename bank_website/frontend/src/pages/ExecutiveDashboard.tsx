...
import { TrendingUp, AlertTriangle, CheckCircle, Clock, Shield, BarChart3 } from 'lucide-react';
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-sm">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-semibold border ${getRiskColor(concern.risk)}`}>
                        {concern.risk} RISK
                      </span>
                    </div>
                  </div>
